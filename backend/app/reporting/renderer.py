    ...
    def render(
        ...
        story.extend([
            ...
            self._table([
                ...
                [_paragraph("Files inventoried", styles["label"]), _paragraph(document.scope.files_discovered if document.scope.files_discovered is not None else "Not recorded", styles["body"])],
                [_paragraph("Analyzable files inspected", styles["label"]), _paragraph(document.scope.files_analyzed if document.scope.files_analyzed is not None else "Not recorded", styles["body"])],
                [_paragraph("Inventory complete", styles["label"]), _paragraph("YES" if document.scope.inventory_complete is True else "NO" if document.scope.inventory_complete is False else "Not recorded", styles["body"])],
                [_paragraph("Inventory truncated", styles["label"]), _paragraph("YES" if document.scope.truncated else "NO", styles["body"])],
                [_paragraph("Bounded fact extraction", styles["label"]), _paragraph(document.scope.partial_files, styles["body"])],
                [_paragraph("Non-analyzable files inventoried", styles["label"]), _paragraph(document.scope.excluded_files, styles["body"])],
